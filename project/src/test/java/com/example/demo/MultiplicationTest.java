...
public class MultiplicationTest extends BaseAPITest {
    ...
    public void testAdditionEndpoint() {
        ...
        Response response = client.post("/multiplication",params);

        // Assertions
        assertEquals(200, response.getStatusCode());
        assertEquals(controlApi.multiplication(params), response.getBody().as(Integer.class));
    }
}
